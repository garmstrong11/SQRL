...
namespace SQRL.DataAccess.Migrations
{
	public partial class SetIdColumnCaseSensitive : DbMigration
	{
		public override void Up()
		{
			...
			sb.AppendLine("ALTER TABLE [dbo].[UrlLinks] ALTER COLUMN UrlLinkId VARCHAR(5) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL");

			sb.AppendLine("ALTER TABLE [dbo].[UrlLinks] ADD CONSTRAINT [PK_dbo.UrlLinks] PRIMARY KEY CLUSTERED ([UrlLinkId] ASC)");
